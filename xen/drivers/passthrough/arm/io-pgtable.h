...
struct io_pgtable_cfg {
	 ...
	 */
	#define IO_PGTABLE_QUIRK_ARM_NS		BIT(0, UL)
	#define IO_PGTABLE_QUIRK_NO_PERMS	BIT(1, UL)
	#define IO_PGTABLE_QUIRK_TLBI_ON_MAP	BIT(2, UL)
	#define IO_PGTABLE_QUIRK_ARM_MTK_4GB	BIT(3, UL)
