/*
 * Code to provide SCF ability to manipulate IOMMU
 *
...
#include "../../arch/arm/coproc/coproc.h"
...
int iommu_assign_coproc(struct domain *d, device_t *dev)
{
    ...
    return hd->platform_ops->assign_coproc(d, dev);
}
...
int iommu_deassign_coproc(struct domain *d, device_t *dev)
{
    ...
    return hd->platform_ops->deassign_coproc(d, dev);
}
...
int iommu_disable_coproc(struct domain *d, device_t *dev)
{
    ...
    return hd->platform_ops->disable_coproc(d, dev);
}
...
int iommu_enable_coproc(struct domain *d, device_t *dev)
{
    ...
    return hd->platform_ops->enable_coproc(d, dev);
}
